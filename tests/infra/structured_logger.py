...
# ── Configuration ─────────────────────────────────────────────────────────────
try:
    from config.settings import LOG_LEVEL as _CFG_LOG_LEVEL, ARTIFACTS_DIR as _CFG_ARTIFACTS_DIR
    LOG_LEVEL  = _CFG_LOG_LEVEL
    _ARTIFACTS = _CFG_ARTIFACTS_DIR
except Exception:
    LOG_LEVEL  = os.environ.get("VANTAGE_LOG_LEVEL", "INFO").upper()
    _ARTIFACTS = Path(os.environ.get("VANTAGE_TEST_ARTIFACTS_DIR", "tests/artifacts"))
