"""
conftest.py — Pytest fixtures for CLI Integration tests (26_cli_integration)
"""
...
def headers():
    ...
    api_key, _org_id, _cookies = fresh_account(prefix="cli26")
...
def account():
    ...
    return fresh_account(prefix="cli26")
