...
export async function corsMiddleware(c: Context<{ Bindings: Bindings }>, next: Next): Promise<void | Response> {
  ...
  if (c.req.method === 'OPTIONS') {
    return new Response(null, {
      ...
      headers: {
        ...
        'Access-Control-Allow-Headers':     'Authorization, Content-Type, X-Vantage-Org, X-Vantage-Privacy',
  ...
  c.res.headers.set('Access-Control-Allow-Headers',     'Authorization, Content-Type, X-Vantage-Org, X-Vantage-Privacy');
